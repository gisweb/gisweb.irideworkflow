...
fieldmaps = dict(
    frm_gara_base = dict(
        ...
        COMP_DATACOMP =     lambda doc: doc.isoDate('gara_data_gara'),
        ...
        COMP_DATA_SOPLUO =  lambda doc: doc.isoDate('gara_data_sopraluogo'),
        COMP_NUM_POLIZZA =  lambda doc: doc.checkItem('gara_polizza_num'),
        COMP_DATA_POLIZZA = lambda doc: doc.isoDate('gara_polizza_data'),
